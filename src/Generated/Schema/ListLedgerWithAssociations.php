...
class ListLedgerWithAssociations implements SerializableInterface, JsonSerializable
{
    private ?int $id = null;
    ...
    private ?ListJournalCollection $journals = null;
    private array $optionalPropertyChanged = array('id' => false, 'name' => false, 'amount' => false, 'type' => false, 'createdAt' => false, 'updatedAt' => false, 'journals' => false);
    /**
     * @param int $id
     * @return self
    */
    ...
    */
    ...
    /**
     * @param ListJournalCollection $journals
     * @return self
    */
    public function setJournals(ListJournalCollection $journals) : self
    {
    ...
    */
    ...
    /**
     * @return ListJournalCollection|null
    */
    public function getJournals() : ?ListJournalCollection
    {
    ...
    */
    public function toArray() : array
    {
        ...
        if ($this->hasJournals()) {
            $fields['journals'] = $this->journals->toArray();
        }
        return $fields;
    }
    /**
