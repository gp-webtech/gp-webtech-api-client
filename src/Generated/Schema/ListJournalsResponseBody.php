...
class ListJournalsResponseBody implements SerializableInterface, JsonSerializable
{
    private ?Pagination $pagination = null;
    private ?ListJournalCollection $data = null;
    ...
    */
    ...
    /**
     * @param ListJournalCollection $data
     * @return self
    */
    public function setData(ListJournalCollection $data) : self
    {
        $this->data = $data;
    ...
    */
    public function getData() : ?ListJournalCollection
    {
        return $this->data;
    }
    /**
