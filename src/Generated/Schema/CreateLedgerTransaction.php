...
class CreateLedgerTransaction implements SerializableInterface, JsonSerializable
{
    private ?string $description = null;
    private ?float $amount = null;
    private ?float $ledger = null;
    private ?CreateLedgerTransactionMetas $metas = null;
    ...
    */
    ...
    /**
     * @param CreateLedgerTransactionMetas $metas
     * @return self
    */
    public function setMetas(CreateLedgerTransactionMetas $metas) : self
    {
        $this->metas = $metas;
    ...
    */
    ...
    /**
     * @return CreateLedgerTransactionMetas|null
    */
    public function getMetas() : ?CreateLedgerTransactionMetas
    {
        return $this->metas;
    }
    /**
