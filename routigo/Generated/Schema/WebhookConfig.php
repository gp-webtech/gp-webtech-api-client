...
class WebhookConfig implements SerializableInterface, JsonSerializable
{
    ...
    */
    public function __construct(string $id, string $routigoEvent, string $routigoEventType, EndpointNotificationAction $action)
    {
        $this->id = $id;
