...
class ListJournalWithAssociations implements SerializableInterface, JsonSerializable
{
    private ?int $id = null;
    ...
    private ?ListLedgerCollection $ledgers = null;
    private array $optionalPropertyChanged = array('id' => false, 'name' => false, 'amount' => false, 'type' => false, 'createdAt' => false, 'updatedAt' => false, 'ledgers' => false);
    /**
     * @param int $id
     * @return self
    */
    ...
    */
    ...
    /**
     * @param ListLedgerCollection $ledgers
     * @return self
    */
    public function setLedgers(ListLedgerCollection $ledgers) : self
    {
    ...
    */
    public function getLedgers() : ?ListLedgerCollection
    {
        return $this->ledgers;
    }
    /**
    ...
    */
    public function toArray() : array
    {
        ...
        if ($this->hasLedgers()) {
            $fields['ledgers'] = $this->ledgers->toArray();
        }
        return $fields;
    }
    /**
